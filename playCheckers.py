...
def main():
    ...
    print("\n\nWelcome to the Checkers game. You control the " + colored("blue", "blue") +
          " pieces. The computer will control the  " + colored("red", "red") + " pieces. " + colored("Red", "red") + " plays first.\n")
    ...
    while game.status == 0:
        ...
        while True:
            ...
            piece = get_coord(
                raw_input("\tEnter coordinates of the piece to move:"))

            if piece == -1:
                continue

            move_loc = get_coord(
                raw_input("\tEnter coordinates of the place to move:"))
